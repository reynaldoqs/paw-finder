...
/** biome-ignore-all lint/a11y/useKeyWithClickEvents: lib */
/** biome-ignore-all lint/a11y/noStaticElementInteractions: lib */
/** biome-ignore-all lint/suspicious/useIterableCallbackReturn: library   */
"use client";
